(function (global, factory) {
...
}(this, (function (exports, core, affix, alert, autoComplete, avatar, backTop, badge, breadcrumb, button, calendar, card, carousel, checkbox, collapse, comment, datePicker, divider, dropdown, grid, icon, input, inputNumber, layout, menu, message, modal, notification, pageHeader, pagination, progress, radio, select, slider, steps, _switch, table, tabs, tag, tooltip, upload, forms, http, common, en, angularSvgIcon, portal, overlay, a11y, router, ng2Charts, i18n, dateFns) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var DatePickerComponent = /** @class */ (function (_super) {
         ...
         * @param open
         */
        DatePickerComponent.prototype.onDatePickerOpen = function (open) {
