...
OptionComponent.decorators = [
    { type: Component, args: [{
                ...
                styles: [".options-container{display:block;min-height:2.5rem;line-height:2.5rem;color:#4f4e4d;background-color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;-webkit-user-select:none;-moz-user-select:none;user-select:none;cursor:pointer}.options-container div{padding:0 5px}.option-item-active{background-color:#f3f3f3;width:100%;outline:none}@media screen and (-ms-high-contrast:active){.option-item-active{background-color:#f3f3f3}}:host{display:block;min-height:2.5rem;line-height:2.5rem;color:#4f4e4d;background-color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;-webkit-user-select:none;-moz-user-select:none;user-select:none;cursor:pointer}:host div{padding:0 5px}:host.active,:host.selected{background-color:#f3f3f3;width:100%;outline:none}@media screen and (-ms-high-contrast:active){:host.active,:host.selected{background-color:#f3f3f3}}:host .enabled:hover{background-color:#f3f3f3;width:100%;outline:none}@media screen and (-ms-high-contrast:active){:host .enabled:hover{background-color:#f3f3f3}}:host.selected{font-weight:700}:host .disabled{color:#93a1aa;cursor:auto}:host .disabled:focus,:host .disabled:hover{outline:none;background-color:#fff}@media screen and (-ms-high-contrast:active){:host .disabled:focus,:host .disabled:hover{background-color:#fff}}.option-container{justify-content:space-between}.option-container,.single-icon{display:flex;align-items:center}.single-icon{justify-content:center}"]
            },] }
];
...
SearchOptionComponent.decorators = [
    { type: Component, args: [{
                ...
                styles: [".options-container{display:block;min-height:2.5rem;line-height:2.5rem;color:#4f4e4d;background-color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;-webkit-user-select:none;-moz-user-select:none;user-select:none;cursor:pointer}.options-container div{padding:0 5px}.option-item-active{background-color:#f3f3f3;width:100%;outline:none}@media screen and (-ms-high-contrast:active){.option-item-active{background-color:#f3f3f3}}.search-option-container{display:block;min-height:2.5rem;line-height:2.5rem;color:#4f4e4d;background-color:#fff;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;-webkit-user-select:none;-moz-user-select:none;user-select:none;cursor:pointer}.search-option-container div{padding:0 5px}.search-option-container.active,.search-option-container:hover{background-color:#f3f3f3;width:100%;outline:none}@media screen and (-ms-high-contrast:active){.search-option-container.active,.search-option-container:hover{background-color:#f3f3f3}}"]
            },] }
];
...
BackNavigationComponent.decorators = [
    { type: Component, args: [{
                ...
                styles: [".back-navigation{display:flex;align-items:center;cursor:pointer;transition:opacity 5ms ease-in-out;width:-moz-fit-content;width:fit-content}.back-icon{transform:translateY(-1px)}.back-navigation:hover{opacity:.7}"]
            },] }
];
...
const appCurrencyExchangeIcon = {
    data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0z"/><path d="M12.89 11.1c-1.78-.59-2.64-.96-2.64-1.9 0-1.02 1.11-1.39 1.81-1.39 1.31 0 1.79.99 1.9 1.34l1.58-.67c-.15-.45-.82-1.92-2.54-2.24V5h-2v1.26c-2.48.56-2.49 2.86-2.49 2.96 0 2.27 2.25 2.91 3.35 3.31 1.58.56 2.28 1.07 2.28 2.03 0 1.13-1.05 1.61-1.98 1.61-1.82 0-2.34-1.87-2.4-2.09l-1.66.67c.63 2.19 2.28 2.78 2.9 2.96V19h2v-1.24c.4-.09 2.9-.59 2.9-3.22 0-1.39-.61-2.61-3.01-3.44zM3 21H1v-6h6v2H4.52c1.61 2.41 4.36 4 7.48 4a9 9 0 009-9h2c0 6.08-4.92 11-11 11-3.72 0-7.01-1.85-9-4.67V21zm-2-9C1 5.92 5.92 1 12 1c3.72 0 7.01 1.85 9 4.67V3h2v6h-6V7h2.48C17.87 4.59 15.12 3 12 3a9 9 0 00-9 9H1z"/></svg>`,
    name: 'currency-exchange'
};

const appSellIcon = {
    data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M21.41 11.41l-8.83-8.83c-.37-.37-.88-.58-1.41-.58H4c-1.1 0-2 .9-2 2v7.17c0 .53.21 1.04.59 1.41l8.83 8.83c.78.78 2.05.78 2.83 0l7.17-7.17c.78-.78.78-2.04-.01-2.83zM6.5 8C5.67 8 5 7.33 5 6.5S5.67 5 6.5 5 8 5.67 8 6.5 7.33 8 6.5 8z"/></svg>`,
    name: 'sell'
};

const appShoppingBagIcon = {
    data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="none" d="M0 0h24v24H0z"/><path d="M18 6h-2c0-2.21-1.79-4-4-4S8 3.79 8 6H6c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V8c0-1.1-.9-2-2-2zm-8 4c0 .55-.45 1-1 1s-1-.45-1-1V8h2v2zm2-6c1.1 0 2 .9 2 2h-4c0-1.1.9-2 2-2zm4 6c0 .55-.45 1-1 1s-1-.45-1-1V8h2v2z"/></svg>`,
    name: 'shopping-bag'
};

const appStarIcon = {
    data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M0 0h24v24H0z" fill="none"/><path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z"/></svg>`,
    name: 'star'
};
...
const appAlarmIcon = {
    data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M22 5.72l-4.6-3.86-1.29 1.53 4.6 3.86L22 5.72zM7.88 3.39L6.6 1.86 2 5.71l1.29 1.53 4.59-3.85zM12.5 8H11v6l4.75 2.85.75-1.23-4-2.37V8zM12 4c-4.97 0-9 4.03-9 9s4.02 9 9 9a9 9 0 000-18zm0 16c-3.87 0-7-3.13-7-7s3.13-7 7-7 7 3.13 7 7-3.13 7-7 7z"/></svg>`,
    name: 'alarm'
};

const appThumbDownIcon = {
    data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M15 3H6c-.83 0-1.54.5-1.84 1.22l-3.02 7.05c-.09.23-.14.47-.14.73v2c0 1.1.9 2 2 2h6.31l-.95 4.57-.03.32c0 .41.17.79.44 1.06L9.83 23l6.59-6.59c.36-.36.58-.86.58-1.41V5c0-1.1-.9-2-2-2zm4 0v12h4V3h-4z"/></svg>`,
    name: 'thumb-down'
};

const appTuneIcon = {
    data: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M0 0h24v24H0z" fill="none"/><path d="M3 17v2h6v-2H3zM3 5v2h10V5H3zm10 16v-2h8v-2h-8v-2h-2v6h2zM7 9v2H3v2h4v2h2V9H7zm14 4v-2H11v2h10zm-6-4h2V7h4V5h-4V3h-2v6z"/></svg>`,
    name: 'tune'
};

const appHistoryBlackIcon = {
    data: `<svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#000000"><path d="M0 0h24v24H0z" fill="none"/><path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z"/></svg>`,
    name: 'history-black'
};
...
const appReceiptIcon = {
    data: `<svg fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="#4F4E4D"><path d="M18.01 2v1.5c.66 0 1.29.27 1.75.72.48.49.74 1.12.74 1.78v2.42c0 .74-.33 1.08-1.08 1.08H17.5V4.01c0-.28.23-.51.51-.51V2zm0 0C16.9 2 16 2.9 16 4.01V11h3.42C21 11 22 10 22 8.42V6c0-1.1-.45-2.1-1.17-2.83A4.044 4.044 0 0018.01 2c.01 0 0 0 0 0z"/><path fill-rule="evenodd" clip-rule="evenodd" d="M2 21V6c0-2.21 1-4 4-4h12c-1.1 0-2 .9-2 2v17c0 .82-.94 1.29-1.6.8l-1.71-1.28a.991.991 0 00-1.3.09l-1.68 1.68c-.39.39-1.03.39-1.42 0l-1.66-1.67c-.36-.36-.92-.4-1.32-.1L3.6 21.8c-.66.5-1.6.03-1.6-.8zm7.55-10.42l1.108.42c.573.21 1.342.66 1.342 2.052 0 1.199-.887 2.163-1.972 2.163H9.55v.452c0 .318-.25.583-.55.583-.301 0-.55-.265-.55-.583v-.452h-.264c-1.203 0-2.18-1.073-2.18-2.395 0-.32.25-.583.55-.583.302 0 .55.264.55.583 0 .677.485 1.228 1.08 1.228h.264V11.42L7.343 11C6.771 10.788 6 10.337 6 8.945c0-1.198.888-2.162 1.974-2.162h.477v-.45c0-.32.25-.584.55-.584.3 0 .55.264.55.583v.45h.264c1.203 0 2.178 1.074 2.178 2.397 0 .32-.25.583-.55.583-.3 0-.55-.264-.55-.583 0-.677-.485-1.23-1.078-1.23H9.55v2.63zm-1.84-.678l.74.274V7.95h-.476c-.477 0-.866.452-.866 1.004 0 .676.228.81.602.948zm1.848 4.146h.47c.477 0 .872-.45.872-.996 0-.676-.227-.809-.6-.948l-.742-.272v2.216z"/></g></svg>`,
    name: 'receipt'
};

const appCodeIcon = {
    data: `<svg xmlns="http://www.w3.org/2000/svg" fill="#1f1f1f" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M9.4 16.6L4.8 12l4.6-4.6L8 6l-6 6 6 6 1.4-1.4zm5.2 0l4.6-4.6-4.6-4.6L16 6l6 6-6 6-1.4-1.4z"/></svg>`,
    name: 'code'
};
...
export { AvatarComponent, BackNavigationComponent, BadgeComponent, BreadcrumbComponent, ButtonComponent, ButtonSize, ButtonType, CardComponent, CheckboxComponent, ChipComponent, DataVisualizationComponent, DatePickerComponent, DialogsComponent, DividerComponent, DropdownComponent, ElevationComponent, HeaderComponent, ICardType, MenuComponent, ProgressBarComponent, ProgressCircleComponent, RadioComponent, SearchComponent, SideNavigationComponent, SideNavigationType, SidebarComponent, SliderComponent, SnackbarComponent, SpComponentsComponent, SpComponentsModule, SpacingComponent, StepsComponent, SwitchComponent, TabComponent, TableComponent, TagType, TextFieldComponent, TooltipComponent, UploadComponent, actionIcons, alertIcons, avIcons, communicationIcons, contentIcons, fileIcons, hardwareIcons, imageIcons, mapsIcons, miscIcons, navigationIcons, notificationIcons, socialIcons, toggleIcons, ɵ0, FormFieldManager as ɵa, BannerComponent as ɵb, appWarningIcon as ɵba, appRecentActorsIcon as ɵbb, appCallIcon as ɵbc, appDraftsIcon as ɵbd, appEmailIcon as ɵbe, appAddCircleOutlineIcon as ɵbf, appAddIcon as ɵbg, appReportIcon as ɵbh, appSendIcon as ɵbi, appUploadFileIcon as ɵbj, appKeyboardTabIcon as ɵbk, appSmartphoneIcon as ɵbl, appEditIcon as ɵbm, appWbIncandescentIcon as ɵbn, appPlaceIcon as ɵbo, appAccountBalanceIcon as ɵbp, appAlarmIcon as ɵbq, appAnalyticsIcon as ɵbr, appArrowDropDownIcon as ɵbs, appArrowDropUpIcon as ɵbt, appAutorenewIcon as ɵbu, appCalendarIcon as ɵbv, appCalendarDateRangeIcon as ɵbw, appCalendarTodayIcon as ɵbx, appCallMergeIcon as ɵby, appCircleIcon as ɵbz, DropdownService as ɵc, appConnectIcon as ɵca, appContentCopyIcon as ɵcb, appCorporateFareIcon as ɵcc, appCreditCard as ɵcd, appCurrencyExchangeIcon as ɵce, appDeleteIcon as ɵcf, appDesktopIcon as ɵcg, appDownloadIcon as ɵch, appFileCopyIcon as ɵci, appFileUploadIcon as ɵcj, appGavelIcon as ɵck, appHelpIcon as ɵcl, appHighlightOffIcon as ɵcm, appInfoIcon as ɵcn, appLinkIcon as ɵco, appLabelIcon as ɵcp, appLockIcon as ɵcq, appLoyaltyIcon as ɵcr, appMenuIcon as ɵcs, appOpenWithIcon as ɵct, appOpenInNew as ɵcu, appPaymentsIcon as ɵcv, appPrivacyTipIcon as ɵcw, appQuizIcon as ɵcx, appRemoveIcon as ɵcy, appRemoveRedEyeIcon as ɵcz, OverlayTemplateComponent as ɵd, appRestoreIcon as ɵda, appScheduleIcon as ɵdb, appSellIcon as ɵdc, appSettingsSuggestIcon as ɵdd, appShoppingBagIcon as ɵde, appStarIcon as ɵdf, appStarsIcon as ɵdg, appThumbDownIcon as ɵdh, appThumbUpIcon as ɵdi, appTuneIcon as ɵdj, appVerticalSplitIcon as ɵdk, appHistoryBlackIcon as ɵdl, appTagIcon as ɵdm, appHashtagCircleIcon as ɵdn, appReceiptIcon as ɵdo, appCodeIcon as ɵdp, appArrowBackIcon as ɵdq, appArrowDownwardIcon as ɵdr, appArrowForwardIcon as ɵds, appArrowUpwardIcon as ɵdt, appCancelBlackIcon as ɵdu, appCheckIcon as ɵdv, appChevronLeftIcon as ɵdw, appChevronRightIcon as ɵdx, appClearIcon as ɵdy, appEastIcon as ɵdz, OptionComponent as ɵe, appExpandLessIcon as ɵea, appExpandMoreIcon as ɵeb, appFirstPageIcon as ɵec, appLastPageIcon as ɵed, appMoreVertIcon as ɵee, appMoreHorizIcon as ɵef, appRefreshIcon as ɵeg, appPriorityHighIcon as ɵeh, appSmsIcon as ɵei, appPeopleIcon as ɵej, appCheckBoxOutlineBlankIcon as ɵek, appCheckBoxIcon as ɵel, appIndeterminateCheckBoxIcon as ɵem, appRadioButtonCheckedIcon as ɵen, appRadioButtonUncheckedIcon as ɵeo, SearchService as ɵf, SearchOptionComponent as ɵg, SearchTemplateComponent as ɵh, MenuService as ɵi, MenuItemComponent as ɵj, MenuTriggerDirective as ɵk, IconComponent as ɵl, RangeCalendarComponent as ɵm, EmptyComponent as ɵn, NZMODULES as ɵo, appAccountBoxIcon as ɵp, appCheckCircleIcon as ɵq, appCheckCircleOutlineIcon as ɵr, appExpandIcon as ɵs, appFavoriteIcon as ɵt, appHomeIcon as ɵu, appLogoutIcon as ɵv, appRedeemIcon as ɵw, appSearchIcon as ɵx, appSettingsIcon as ɵy, appErrorIcon as ɵz };
